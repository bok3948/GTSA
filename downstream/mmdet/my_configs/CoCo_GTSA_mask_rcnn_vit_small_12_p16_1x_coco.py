...
#init_cfg=dict(type='Pretrained', checkpoint='dino_vissl.pth')
...
model = dict(
    backbone=dict(
        ...
        init_cfg=dict(type='Pretrained', checkpoint='/workspace/final/GTSA_exps/my_pretrain/GTSA/CoCo_GTSA_99ep.pth')
    ),
